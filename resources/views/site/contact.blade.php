        ...
        <div class="container">
            <div class="row clearfix">
                ...
                <section class="col-lg-9 col-md-9 col-sm-9">
                    <h2 class="tt_uppercase color_dark m_bottom_25">CONTATO</h2>
                            ...
                            <ul class="c_info_list">
                                <li class="m_bottom_10">
                                    <div class="clearfix m_bottom_15">
                                        ...
                                        <p class="contact_e">Rua Blablablablabl, 123<br> São Paulo - SP</p>
                                    </div>
                                </li>
                                <li class="m_bottom_10">
                                    <div class="clearfix m_bottom_10">
                                        <i class="fa fa-phone f_left color_dark"></i>
                                        <p class="contact_e">(11) 91234-5678</p>
                                    </div>
                                </li>
                                <li class="m_bottom_10">
                                    <div class="clearfix m_bottom_10">
                                        <i class="fa fa-envelope f_left color_dark"></i>
                                        <a class="contact_e default_t_color" href="mailto:#">contato@siriuspersonalize.com.br</a>
                                    </div>
                                </li>
                                <li>
                                    <div class="clearfix">
                                        <i class="fa fa-clock-o f_left color_dark"></i>
                                        <p class="contact_e">Segunda - Sexta: 08:00-18:00 <br>Sabádo: 09.00-15.00<br> Sunday: closed</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
