...
<div class="boxed_layout relative w_xs_auto">
    ...
    <div class="camera_wrap m_bottom_0">
        <div data-src="{{asset('assets/images/slide_02.jpg')}}" data-custom-thumb="{{asset('images/slide_02.jpg')}}">
        ...
        <div data-src="{{asset('assets/slide_01.jpg')}}" data-custom-thumb="{{asset('assets/images/slide_01.jpg')}}">
