                            ...
                            <div class="shopping_cart top_arrow tr_all_hover r_corners">
                                ...
                                <ul class="products_list">
                                    <li>
                                        <div class="clearfix">
                                            <!--product image-->
                                            <img class="f_left m_right_10" src="{{asset('assets/images/shopping_c_img_1.jpg')}}" alt="">
                                            <!--product description-->
                                    ...
                                    <li>
                                        <div class="clearfix">
                                            <!--product image-->
                                            <img class="f_left m_right_10" src="{{asset('assets/images/shopping_c_img_2.jpg')}}" alt="">
                                            <!--product description-->
                                            <div class="f_left product_description">
                                                <a href="#" class="color_dark m_bottom_5 d_block">Cursus eleifend elit aenean auctor wisi et urna</a>
                                                <span class="f_size_medium">Product Code PS34</span>
                                    ...
                                    <li>
                                        <div class="clearfix">
                                            <!--product image-->
                                            <img class="f_left m_right_10" src="{{asset('assets/images/shopping_c_img_3.jpg')}}" alt="">
                                            <!--product description-->
                                            <div class="f_left product_description">
                                                <a href="#" class="color_dark m_bottom_5 d_block">Cursus eleifend elit aenean auctor wisi et urna</a>
                                                <span class="f_size_medium">Product Code PS34</span>
        ...
        <div class="footer_bottom_part">
            <div class="container clearfix t_mxs_align_c">
                ...
                <ul class="f_right horizontal_list clearfix f_mxs_none d_mxs_inline_b">
                    <li><img src="{{asset('assets/images/payment_img_1.png')}}" alt=""></li>
                    <li class="m_left_5"><img src="{{asset('assets/images/payment_img_2.png')}}" alt=""></li>
                    <li class="m_left_5"><img src="{{asset('assets/images/payment_img_3.png')}}" alt=""></li>
                    <li class="m_left_5"><img src="{{asset('assets/images/payment_img_4.png')}}" alt=""></li>
                    <li class="m_left_5"><img src="{{asset('assets/images/payment_img_5.png')}}" alt=""></li>
                </ul>
            </div>
        </div>
    </footer>
            ...
            <div class="custom_scrollbar">
                ...
                <div class="f_left half_column">
                    <div class="relative d_inline_b m_bottom_10 qv_preview">
                        <span class="hot_stripe"><img src="{{asset('assets/images/sale_product.png')}}" alt=""></span>
                        <img src="{{asset('assets/images/quick_view_img_1.jpg')}}" class="tr_all_hover" alt="">
                    </div>
                    <!--carousel-->
                    <div class="relative qv_carousel_wrap m_bottom_20">
                        ...
                        <ul class="qv_carousel d_inline_middle">
                            <li data-src="images/quick_view_img_1.jpg"><img src="{{asset('assets/images/quick_view_img_4.jpg')}}" alt=""></li>
                            <li data-src="images/quick_view_img_2.jpg"><img src="{{asset('assets/images/quick_view_img_5.jpg')}}" alt=""></li>
                            <li data-src="images/quick_view_img_3.jpg"><img src="{{asset('assets/images/quick_view_img_6.jpg')}}" alt=""></li>
                            <li data-src="images/quick_view_img_1.jpg"><img src="{{asset('assets/images/quick_view_img_4.jpg')}}" alt=""></li>
                            <li data-src="images/quick_view_img_2.jpg"><img src="{{asset('assets/images/quick_view_img_5.jpg')}}" alt=""></li>
                            <li data-src="images/quick_view_img_3.jpg"><img src="{{asset('assets/images/quick_view_img_6.jpg')}}" alt=""></li>
                        </ul>
